...
if __name__ == "__main__":
    iterations_list = [80]
    bond_dim_list = [55, 60, 65, 70, 75, 80, 85, 90, 95, 105, 110, 120,130,140,150,160,170,180,190,200, 250, 300]

    results = run_experiments(iterations_list, bond_dim_list)
    save_results(results, filename="mps_gate_implementation_results_5")
